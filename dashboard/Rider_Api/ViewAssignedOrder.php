...
<?php
        ...
        $Id=$_GET['r_id'];
        //print_r($con);
        $rows =  ExecuteQuery("SELECT DISTINCT tbl_orderitems.invoice, tbl_users.address, tbl_orderitems.ordercreateddate 
        from tbl_users 
        ...
        where tbl_riderorder.riderid = '5' and tbl_order.status='Assigned'");
        $itens = array();
        $index = 0;
