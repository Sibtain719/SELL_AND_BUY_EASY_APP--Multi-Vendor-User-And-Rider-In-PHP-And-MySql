                                    ...
                                    <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $rows =  ExecuteQuery("SELECT 
                                                  ...
                                                  where tbl_role.name = 'vendor' OR tbl_role.name='VENDOR' OR tbl_role.name='Vendor'");
...
<!-- Mirrored from crm.thememinister.com/crmAdmin/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Feb 2019 19:56:46 GMT -->
