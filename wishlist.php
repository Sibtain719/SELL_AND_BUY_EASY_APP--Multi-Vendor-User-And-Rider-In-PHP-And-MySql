      ...
      <div class="container">
        <div class="header-left">
          <div class="header-icon-group">
            ...
            ><a class="header-logo" href="index.html"
              ><img src="../../images/logo 1 (1).png" alt="logo" /></a
            ><button class="icon-cross"><i class="icofont-close"></i></button>
          </div>
          <div class="select-option">
            <img
              class="img"
              src="../../images/language/english.png"
              alt="language"
        ...
        <form class="header-middle">
          <div class="select-option">
            ...
            <ul class="option-list">
              <li>
                <a href="../grocery/index.html"
                  ><i class="icofont-grocery"></i><span>grocery</span></a
                >
              </li>
              <li>
                <a href="../bakery/index.html"
                  ><i class="icofont-cup-cake"></i><span>bakery</span></a
                >
              </li>
            </ul>
          </div>
        ...
        <div class="header-right">
          ...
          <div class="header-icon-group">
            ...
            ><button class="icon-check">
              <i class="icofont-shopping-cart"></i><span>$00.00</span
              ><sup>0</sup>
            </button>
          </div>
        </div>
        ...
        <ul class="cart-list">
          ...
          <li class="cart-item alert fade show">
            <div class="cart-image">
              <a href="#"
                ><img
                  src="../../images/shop/product/grocery/02.jpg"
                  alt="product"
              /></a>
            </div>
            <div class="cart-info">
          ...
          <li class="cart-item alert fade show">
            <div class="cart-image">
              <a href="#"
                ><img
                  src="../../images/shop/product/grocery/03.jpg"
                  alt="product"
              /></a>
            </div>
            <div class="cart-info">
          ...
          <li class="cart-item alert fade show">
            <div class="cart-image">
              <a href="#"
                ><img
                  src="../../images/shop/product/grocery/04.jpg"
                  alt="product"
              /></a>
            </div>
            <div class="cart-info">
          ...
          <li class="cart-item alert fade show">
            <div class="cart-image">
              <a href="#"
                ><img
                  src="../../images/shop/product/grocery/05.jpg"
                  alt="product"
              /></a>
            </div>
            <div class="cart-info">
              ...
              <table class="table-list">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <h5>$18<small>/kilo</small></h5>
                    </td>
                    <td><h5 class="stock-in">stock in</h5></td>
                    <td><a class="table-cart" href="#">Add to Cart</a></td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="../../images/shop/product/grocery/08.jpg"
                        alt="product"
                      />
                    </td>
                    <td><h5>product name</h5></td>
                    <td>
                      <h5>$23<small>/pice</small></h5>
                    </td>
                    <td><h5 class="stock-out">stock out</h5></td>
                    <td><a class="table-cart" href="#">Add to Cart</a></td>
                    <td>
                      <ul class="table-action">
                        <li>
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="../../images/shop/product/grocery/20.jpg"
                        alt="product"
                      />
                    </td>
                    <td><h5>product name</h5></td>
                    <td>
                      <h5>$15<small>/packet</small></h5>
                    </td>
                    <td><h5 class="stock-in">stock in</h5></td>
                    <td><a class="table-cart" href="#">Add to Cart</a></td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="../../images/shop/product/grocery/09.jpg"
                        alt="product"
                      />
                    </td>
                    <td><h5>product name</h5></td>
                    <td>
                      <h5>$7<small>/kilo</small></h5>
                    </td>
                    <td><h5 class="stock-out">stock out</h5></td>
                    <td><a class="table-cart" href="#">Add to Cart</a></td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="../../images/shop/product/grocery/19.jpg"
                        alt="product"
                      />
                    </td>
                    <td><h5>product name</h5></td>
                    <td>
                      <h5>$9<small>/packet</small></h5>
                    </td>
                    <td><h5 class="stock-in">stock in</h5></td>
                    <td><a class="table-cart" href="#">Add to Cart</a></td>
                    <td>
              ...
              <div class="col-md-6 col-lg-6">
                <div class="product-details">
                  ...
                  <h3 class="details-price">
                    <span>$124.00</span><del>$42.00</del>
                  </h3>
